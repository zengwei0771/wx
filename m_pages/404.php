...
<html>
    ...
    <body>
        <div style="margin:160px 0 0 0;text-align:center;color:#8f8f8f;font-size:20px;">
            页面未找到, <span id="second">3</span>秒后跳转到<a href="http://<?php echo $m_site_domain;?>/" title="<?php echo $site_name;?>" style="color:#62b934;text-decoration:none;">首页</a>
        </div>

        <script>
            setTimeout(function() {
                location.href = "http://<?php echo $m_site_domain;?>/";
            }, 3000);
